...
namespace DeepWolf.HungerThirstSystem.Examples
{
    public class PlayerHealth : MonoBehaviour
    {
        ...
        /// </summary>
        [Header("HUD")] [Tooltip("Should the HUD be shown?")] [SerializeField] private bool _showHUD = false;

        /// <summary>
        /// The health label.
        /// </summary>
        [Tooltip("The health label.")] [SerializeField] private Text _healthLbl = null;
